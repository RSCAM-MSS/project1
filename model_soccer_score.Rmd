...
Ord_pdf <- function(y,delta,beta,i,j,t,data) {
  if(y == 0)
    return(Ord_cdf(y,delta,beta,i,j,t,data)) 
  else if(y == 1) {
    p0 = Ord_cdf(0,delta,beta,i,j,t,data)
    p1 = Ord_cdf(y,delta,beta,i,j,t,data)
    return(p1-p0)
  }
  else if (y == 2) {
    p1 = Ord_cdf(1,delta,beta,i,j,t,data)
    p2 = Ord_cdf(y,delta,beta,i,j,t,data)
    return(p2-p1)
  }
}
```
...
ll <- function(data,theta) {
  ...
  for (k in 1:N) {
    ...
    ll = ll + log10(Ord_pdf(y,delta,beta,i,j,t,data))
  }
