...
# a3 = team i win WDL_2
RPS.data<-fastDummies::dummy_cols(trdata,select_columns = "WDL",remove_first_dummy = FALSE)

# Create the baseline p1, p2, p3
# Get the vector of interest
i = as.numeric(trdata$H)
j = as.numeric(trdata$A)
t = trdata$Date

# 1 - For baseline function, using the value from optimise function
...
#Get the probability to obtain y=0

RPS.data$p0 = mapply(function(i,j,t) Ord_pdf(0,c(par2,par3),par1,i,j,t),i=i,j=j,t=t)

#Get the probability to obtain y=1

RPS.data$p1 = mapply(function(i,j,t) Ord_pdf(1,c(par2,par3),par1,i,j,t),i=i,j=j,t=t)

#Get the probability to obtain y=2

RPS.data$p2 = mapply(function(i,j,t) Ord_pdf(2,c(par2,par3),par1,i,j,t),i=i,j=j,t=t)

# Get the RPS 
RPS.data$RPS = mapply(function(p0,p1,a0,a1) ((p0-a0)^2 + (p0-a0+p1-a1)^2),p0 = RPS.data$p0,p1 = RPS.data$p1, a0 =RPS.data$WDL_0,a1 = RPS.data$WDL_1)

#RPS.ord.data= as.data.frame(RPS.data$HT,RPS.data$WDL_0,RPS.data$WDL_1,RPS.data$WDL_2,RPS.data$p0,RPS.data$p1,RPS.data$p2)

RPS.data$Outcome = mapply(function(p0,p1,p2) (which.max(c(p0,p1,p2))-1),p0 = RPS.data$p0,p1 = RPS.data$p1,p2 = RPS.data$p2)

RPS.data$Accuracy = as.numeric(RPS.data$Outcome == RPS.data$WDL)

RPS.ord.data = RPS.data

View(RPS.ord.data)

# 2 - For Davidson function, using the value from optimise function
# TO DO 
par1 =  0.6039006 
par2 = 0.6671990
...
#Get the probability to obtain y=0
y = RPS.data$WDL_0
RPS.data$p0 = mapply(function(y,i,j,t) Dav_pdf(y,par2,par1,i,j,t),y=y,i=i,j=j,t=t)

#Get the probability to obtain y=1
y = RPS.data$WDL_1
RPS.data$p1 = mapply(function(y,i,j,t) Dav_pdf(y,par2,par1,i,j,t),y=y,i=i,j=j,t=t)

#Get the probability to obtain y=2
y = RPS.data$WDL_2
RPS.data$p2 = mapply(function(y,i,j,t) Dav_pdf(y,par2,par1,i,j,t),y=y,i=i,j=j,t=t)
...
RPS.data.davidson = RPS.data
View(RPS.data.davidson)
