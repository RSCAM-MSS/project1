...
y = RPS.data$WDL_1
RPS.data$p1 = mapply(function(y,i,j,t) Ord_pdf(y,c(par1,par2),par3,i,j,t,RPS.data),y=y,i=i,j=j,t=t)

#Get the probability to obtain y=2
y = RPS.data$WDL_2
RPS.data$p2 = mapply(function(y,i,j,t) Ord_pdf(y,c(par1,par2),par3,i,j,t,RPS.data),y=y,i=i,j=j,t=t)
