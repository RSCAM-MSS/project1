...
#Test - should be 1, as its bayern munich 
...
y = RPS.data$WDL_0
RPS.data$p0 = mapply(function(y,i,j,t) Ord_pdf(y,c(par1,par2),par3,i,j,t,RPS.data),y=y,i=i,j=j,t=t)

#Get the probability to obtain y=1
y = RPS.data$WDL_1
RPS.data$p1 = mapply(function(y,i,j,t) Ord_pdf(y,c(delta0,delta1),beta,i,j,t,RPS.data),y=y,i=i,j=j,t=t)

#Get the probability to obtain y=2
y = RPS.data$WDL_2
RPS.data$p2 = mapply(function(y,i,j,t) Ord_pdf(y,c(delta0,delta1),beta,i,j,t,RPS.data),y=y,i=i,j=j,t=t)
...
#Get the probability to obtain y=0
y = RPS.data$WDL_0
RPS.data$p0 = mapply(function(y,i,j,t) Dav_pdf(y,par1,par2,i,j,t,RPS.data),y=y,i=i,j=j,t=t)

#Get the probability to obtain y=1
y = RPS.data$WDL_1
RPS.data$p1 = mapply(function(y,i,j,t) Dav_pdf(y,par1,par2,i,j,t,RPS.data),y=y,i=i,j=j,t=t)

#Get the probability to obtain y=2
y = RPS.data$WDL_2
RPS.data$p2 = mapply(function(y,i,j,t) Dav_pdf(y,par1,par2,i,j,t,RPS.data),y=y,i=i,j=j,t=t)
