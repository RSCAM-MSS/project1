...
y = RPS.data$WDL_0
RPS.data$p0 = mapply(function(y,i,j,t) Ord_pdf(y,c(delta,1-delta),beta,i,j,t,RPS.data),y=y,i=i,j=j,t=t)

#Get the probability to obtain y=1
y = RPS.data$WDL_1
RPS.data$p1 = mapply(function(y,i,j,t) Ord_pdf(y,c(delta,1-delta),beta,i,j,t,RPS.data),y=y,i=i,j=j,t=t)

#Get the probability to obtain y=2
y = RPS.data$WDL_2
RPS.data$p2 = mapply(function(y,i,j,t) Ord_pdf(y,c(delta,1-delta),beta,i,j,t,RPS.data),y=y,i=i,j=j,t=t)
...
# TO DO 
beta = -0.6552317 -0.3496924  0.6944607
delta = 0.6671990
